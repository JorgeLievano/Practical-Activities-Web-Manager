...
public class TsscTopic implements Serializable {
	...
	@Min(value = 1,message = "el numero de sprints debe ser mayor a 0")
	private long defaultSprints;

	@Column(name = "DEFAULT_GROUPS")
	@Min(value = 1,message = "el numero de grupos debe ser mayor a 0")
	private long defaultGroups;

	@Column(name = "GROUP_PREFIX")
	@NotBlank(message = "agregue una prefijo")
