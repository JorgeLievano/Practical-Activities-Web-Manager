...
public class TsscStory implements Serializable {
	...
	@NotNull(message="Agregue un valor mayor a 0")
	@Min(value = 1,message = "el valor de negocio debe ser mayor a 0")
	...
	@NotNull(message="Agregue un valor mayor a 0")
	@Min(value = 1,message = "el sprint inicial debe ser mayor a 0")
