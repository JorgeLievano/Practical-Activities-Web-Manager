...
public class TsscGame implements Serializable {
	...
	@Size(min = 6,groups = {TsscGameValidateBasic.class,TsscGameValidateEdit.class},message = "Debe contener al menos 6 caracteres")
	@NotBlank(groups = {TsscGameValidateBasic.class},message = "Ingrese una contraseña")
	private String adminPassword;

	@Column(name = "GUEST_PASSWORD")
	@NotBlank(groups = {TsscGameValidateBasic.class,TsscGameValidateEdit.class},message = "Ingrese una contraseña")
	@Size(min = 6,groups = {TsscGameValidateBasic.class,TsscGameValidateEdit.class},message = "Debe contener al menos 6 caracteres")
	private String guestPassword;

	@Column(name = "N_GROUPS")
	@Min(message = "El numero de grupos deber ser mayor a 0",groups = {TsscGameValidateComp.class,TsscGameValidateEdit.class}, value = 1)
	private Integer nGroups = 4;

	@Column(name = "N_SPRINTS")
	@Min(message = "El numero de sprints deber ser mayor a 0",groups = {TsscGameValidateComp.class,TsscGameValidateEdit.class}, value = 1)
	private Integer nSprints = 4;

	@NotBlank(groups = {TsscGameValidateBasic.class,TsscGameValidateEdit.class},message = "Ingrese un nombre")
	@Size(min = 1,groups = {TsscGameValidateBasic.class,TsscGameValidateEdit.class},message = "nombre invalida")
	private String name;
	...
	@NotNull(groups = {TsscGameValidateBasic.class},message = "debe seleccionar una fecha")
	private LocalDate scheduledDate;

	@Column(name = "SCHEDULED_TIME")
	@DateTimeFormat(iso = ISO.TIME)
	@NotNull(groups = {TsscGameValidateBasic.class},message = "debe seleccionar una hora")
	...
	@NotNull(groups = {TsscGameValidateTopic.class},message = "Debe seleccionar un tema")
